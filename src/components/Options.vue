  ...
  <section class="mt-5">
    <v-layout>
      ...
      <v-tooltip top>
        ...
        <span>The tool will generate a password with the chosen length,
          <br>containing the chosen number of digits and symbols, filling the remaining slots with letters.
          <br>Notes:
          <br>- letters will be randomly upper-cased;
          <br>- digits + symbols will always be lower or equal to length;
          <br>- if you set digits + symbols = length, password will not contain any letter.
        </span>
      </v-tooltip>
    </v-layout>
